...
public class Fire : MonoBehaviour
{
    ...
    public void Fire_(int penetration, float damage, float force, GameObject tracer, Vector3 direction, Vector3 firePosition)
    {
        ...
        if (tracer != null && traceEvery <= shotCountTracer)
        {
            ...
            tracer.GetComponent<ParticleSystem>().Simulate(0.02f);
        }
